...
<html lang="en">
  ...
  <head>
    ...
    <title>Hotel ABC | Rooms Reservation</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand hidden-print" href="/">Hotel ABC</a>
        <sec:authorize access="hasAnyRole('ADMIN','STAFF')">
          <a href="#" class="nav-link disabled" disabled> | Logged in as ${userRoleToDisplay}</a>
        </sec:authorize>        
